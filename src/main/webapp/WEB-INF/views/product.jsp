    ...
    <script type="text/javascript">
        $(function () {
          ...
          $("#shopping").click(function () {
              ...
              window.location.href=("${pageContext.request.contextPath}/cart/confirmOrder.do?pid="+pid+"&count="+count);
          })
        })
    </script>
</head>
    	...
    	<div class="deta-info1">
        	<div class="dt-if1-l f-l">
            	<div class="dt-if1-datu">
                	<ul qie-da="">
                       <li><a href="#"><img src="http://localhost/shop10_back/${productByPid.image}"  width="380px" height="350px"/></a></li>
                ...
                <div class="dt-if1-qietu">
                    ...
                    <div class="dt-qie-con f-l">
                    	<ul qie-xiao="">
                        	<li class="current"><a href="#"><img src="http://localhost/shop10_back/${productByPid.image}" width="60"height="60"/></a></li>
                        	<li><a href="#"><img src="http://localhost/shop10_back/${productByPid.image}" width="60"height="60"/></a></li>
                        	<li><a href="#"><img src="http://localhost/shop10_back/${productByPid.image}" width="60"height="60"/></a></li>
                        	<li><a href="#"><img src="http://localhost/shop10_back/${productByPid.image}" width="60"height="60"/></a></li>
        	...
        	<div class="dt-if1-m f-l">
                ...
                <div class="dt-ifm-gojia">
                	<dl>
                        ...
                        <dd>
                        	<p class="p1">
                               <span class="sp1">￥${productByPid.shop_price}</span><span class="sp2">${productByPid.market_price}</span>
                            </p>
                            <p class="p2">
                ...
                <dl class="dt-ifm-box3">
                    <form action="${pageContext.request.contextPath}/cart/confirmBycaritem?pid=${productByPid.pid}" method="post">
                	<%--<input type="hidden" name="pid" value="${productByPid.pid}">
                       <input type="hidden" name="subtotal" value="${productByPid.shop_price}">--%>
                       <dt>数量</dt>
                    <dd>
                    	<a class="box3-left" name="left" href="JavaScript:;">-</a>
                        <input type="number" name="count" id="count" value="1" required min="1" max="999">
                    	<a class="box3-right" name="right" href="JavaScript:;">+</a>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
                <div class="dt-ifm-box4">
                	<button id="shopping" class="btn1">立即购买</button>
                </form>
                	<button class="btn2" name="addCart" value="${productByPid.pid}">加入购物车</button>
        ...
        <div class="deta-info2">
            ...
            <div class="dt-if2-r f-r">
                ...
                <div style="border:1px solid #DBDBDB;" com-det-show="dt1">
                	<div class="if2-tu1">
                        <p>${productByPid.pdesc}</p>
                        <img src="http://localhost/shop10_back/${productByPid.image}" width="600px" height="800px"/>
