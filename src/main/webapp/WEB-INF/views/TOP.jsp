...
<div class="logo-search w1200">
    <div class="logo-box f-l">
        <div class="logo f-l">
            <a href="${pageContext.request.contextPath}/ai.com" title="中林logo"><img src="${pageContext.request.contextPath}/images/zl2-01.gif" /></a>
        </div>
    ...
    <div class="search f-r">
        <form action="${pageContext.request.contextPath}/product/findProducts.do?pageNow=1" method="get">
            <input type="Hidden" name="pageNow" value="1">
        <div class="search-info">
            <input type="text" id="pname" name="pname" placeholder="请输入商品名称" value="${pageBeanForProduct.pname}" />
            <button>搜索</button>
            <div style="clear:both;"></div>
        </div>
        </form>
        <ul class="search-ul">
            <c:forEach items="${hotProductForSearch}" var="pro">
               <%-- <a href="JavaScript:;">--%>
           <li><a href="${pageContext.request.contextPath}/product/findProducts.do?pageNow=1&pname=${pro.pname}" >${pro.pname}</a></li>
            </c:forEach>
            <div style="clear:both;"></div>
        </ul>
    </div>
